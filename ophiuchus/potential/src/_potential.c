...
double wang_zhao_bar_value(double t, double *pars, double *r, int n_dim) {
    /*  pars:
    ...
    */
    ...
    return scf_value(t, &new_pars[0], &rot_r[0], n_dim);
}

void wang_zhao_bar_gradient(double t, double *pars, double *r, int n_dim, double *grad) {
    /*  pars:
            - G (Gravitational constant)
            - m (mass scale)
            - r_s (length scale)
    ...
    */
    ...
    scf_gradient(t, &new_pars[0], &rot_r[0], n_dim, &tmp_grad[0]);
...
double wang_zhao_bar_density(double t, double *pars, double *r, int n_dim) {
    /*  pars:
            - G (Gravitational constant)
            - m (mass scale)
            - r_s (length scale)
    ...
    */
    ...
    return scf_density(t, &new_pars[0], &rot_r[0], n_dim);
}
